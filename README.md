![docker image](https://github.com/AK-Feldhoff-LUH/nomad-distro-dev/actions/workflows/docker-publish.yml/badge.svg)


# AK-Feldhoff-LUH's NOMAD Oasis Distribution

This is the NOMAD Oasis distribution of AK-Feldhoff-LUH.
...
2. Clone the repository or download the repository as a zip file.
    ...
    ```sh
    git clone https://github.com/AK-Feldhoff-LUH/nomad-distro-dev.git
    cd nomad-distro-dev
    ```
    ...
    ```sh
    curl-L -o nomad-distro-dev.zip "https://github.com/AK-Feldhoff-LUH/nomad-distro-dev/archive/main.zip"
...
your `docker-compose.yaml` with `ghcr.io/ak-feldhoff-luh/nomad-distro-dev:main` for the services
...
```sh
docker pull ghcr.io/ak-feldhoff-luh/nomad-distro-dev/jupyter:main
```
...
_I get an_ `Error response from daemon: Head "https://ghcr.io/v2/AK-Feldhoff-LUH/nomad-distro-dev/manifests/main": unauthorized`
